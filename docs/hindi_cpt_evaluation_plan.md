...
`docs/eval_benchmarks_download.md`).
...
Data download: `docs/eval_benchmarks_download.md`.
...
(`docs/eval_benchmarks_download.md`), and **reserve a held-out `hi-proverbs` slice
